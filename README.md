...
* Chrome : Click **Settings** -> **Extensions** -> Check **Developer mode**-> **Load unpacked extension**, navigate to the `chrome/BaiduExporter` folder, click OK.
* Firefox : Open **about:debugging** in Firefox, click "Load Temporary Add-on" and navigate to the `chrome/BaiduExporter` folder, click OK.
...
* Edge: You need at least Windows 10 build 14342
    ...
    3. Click **More(...)** -> **Extensions** -> **Load extension**, navigate to the `chrome/BaiduExporter` folder, click OK.
